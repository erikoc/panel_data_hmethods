...
#x <- y coeftest(plm_fit, vcov=vcovHC(plm_fit,type="HC0",cluster="group"))
```
...
timing <- system.time({results <- doMonteCarlo(nsim, T, n, beta = beta, DGP = "K1" , endogenous = FALSE, error = "hetero_both", rho = 0.5)})
print(timing)
